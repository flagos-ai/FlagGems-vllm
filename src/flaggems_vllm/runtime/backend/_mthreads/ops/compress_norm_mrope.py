...
def run(raw_cache, raw_block_table, token_to_req, logical_positions, compressed_slots,
        compressed_cache, norm_weight, cos_sin_cache, compress_ratio, norm_eps,
        rotary_dim, mrope_section, mrope_interleaved, rope_cache):
