...
if torch_device_fn.is_available() and get_device_capability() >= (3, 1):
...
def _per_token_group_quant_fp8_vec(
    ...
    # Native cvt, see the note at the top of this file.
...
def _ngroups_per_program(
    ...
    # Fuse neighbouring groups into one ~1024-element tile per program; a
    # single warp per program with 16B vectorized accesses saturates memory
    # bandwidth best on MTT S5000.
