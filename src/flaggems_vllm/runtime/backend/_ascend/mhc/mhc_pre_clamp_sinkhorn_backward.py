...
def _fused_gemm_rmsbwd_ybwd_kernel(
    ...
    gm00 = tl.load(grad_mixes_ptr + gm_base + 0)  # noqa: F841
    gm01 = tl.load(grad_mixes_ptr + gm_base + 1)  # noqa: F841
    gm02 = tl.load(grad_mixes_ptr + gm_base + 2)  # noqa: F841
    gm03 = tl.load(grad_mixes_ptr + gm_base + 3)  # noqa: F841
    gm04 = tl.load(grad_mixes_ptr + gm_base + 4)  # noqa: F841
    gm05 = tl.load(grad_mixes_ptr + gm_base + 5)  # noqa: F841
    gm06 = tl.load(grad_mixes_ptr + gm_base + 6)  # noqa: F841
    gm07 = tl.load(grad_mixes_ptr + gm_base + 7)  # noqa: F841
    gm08 = tl.load(grad_mixes_ptr + gm_base + 8)  # noqa: F841
    gm09 = tl.load(grad_mixes_ptr + gm_base + 9)  # noqa: F841
    gm10 = tl.load(grad_mixes_ptr + gm_base + 10)  # noqa: F841
    gm11 = tl.load(grad_mixes_ptr + gm_base + 11)  # noqa: F841
    gm12 = tl.load(grad_mixes_ptr + gm_base + 12)  # noqa: F841
    gm13 = tl.load(grad_mixes_ptr + gm_base + 13)  # noqa: F841
    gm14 = tl.load(grad_mixes_ptr + gm_base + 14)  # noqa: F841
    gm15 = tl.load(grad_mixes_ptr + gm_base + 15)  # noqa: F841
    gm16 = tl.load(grad_mixes_ptr + gm_base + 16)  # noqa: F841
    gm17 = tl.load(grad_mixes_ptr + gm_base + 17)  # noqa: F841
    gm18 = tl.load(grad_mixes_ptr + gm_base + 18)  # noqa: F841
    gm19 = tl.load(grad_mixes_ptr + gm_base + 19)  # noqa: F841
    gm20 = tl.load(grad_mixes_ptr + gm_base + 20)  # noqa: F841
    gm21 = tl.load(grad_mixes_ptr + gm_base + 21)  # noqa: F841
    gm22 = tl.load(grad_mixes_ptr + gm_base + 22)  # noqa: F841
    gm23 = tl.load(grad_mixes_ptr + gm_base + 23)  # noqa: F841
