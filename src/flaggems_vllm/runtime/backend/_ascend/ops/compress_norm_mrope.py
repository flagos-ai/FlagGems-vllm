...
def qwen4_compress_norm_mrope_store_groups(
    raw_cache, raw_block_table, token_to_req, logical_positions, compressed_slots,
    compressed_cache, norm_weight, cos_sin_cache, compress_ratio=4, norm_eps=1e-6,
    rotary_dim=64, mrope_section=(11, 11, 10), mrope_interleaved=True, rope_cache=None,
):
...
def run(raw_cache, raw_block_table, token_to_req, logical_positions, compressed_slots,
    ...
    qwen4_compress_norm_mrope_store_groups(
        raw_cache, raw_block_table, token_to_req, logical_positions, compressed_slots,
        compressed_cache, norm_weight, cos_sin_cache, compress_ratio, norm_eps, rotary_dim,
        tuple(mrope_section), mrope_interleaved, rope_cache,
    )
