...
"""Ascend910-optimized Qwen4 QSA MQA paged dot product.
...
def _qsa_mqa_paged_dot_kernel(
    ...
    # ---- Row metadata (int32; safe: qpos<=4095, seqlen<=4096, visible<=1024) ----
    ...
    vis1 = (qpos + 1) // COMPRESS_RATIO
    vis2 = seqlen // COMPRESS_RATIO
    visible = tl.minimum(vis1, vis2)
