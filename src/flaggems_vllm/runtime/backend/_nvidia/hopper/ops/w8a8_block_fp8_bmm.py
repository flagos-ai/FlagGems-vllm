...
if has_triton_tle(3, 6, 0):
    try:
        ...
        HAS_TLE_W8A8_BLOCK_FP8_BMM = hasattr(tle.gpu, "alloc_barriers") and hasattr(
...
def _get_tle_w8a8_block_fp8_bmm_configs():
    ...
    # correct once the persistent barrier ring continues across output tiles.
    configs = [
        config
    ...
    if configs:
        return configs
    return _filter_tle_w8a8_block_fp8_bmm_configs(
        runtime.ops_get_configs("w8a8_block_fp8_bmm")
    )
...
def _tle_w8a8_block_fp8_bmm_compute_partition(
    ...
    for tile_id in range(start_pid, num_tiles, num_sms):
        ...
        # A persistent CTA keeps the same mbarriers while advancing by
        ...
        for k_block_idx in range(0, num_k_blocks):
            ...
            index = ring_iter % num_stages
            phase = ring_iter // num_stages
