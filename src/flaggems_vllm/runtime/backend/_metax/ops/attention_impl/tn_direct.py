...
def launch_d256_tn_direct(
    ...
    *,
    ...
    from .tn_direct_bulk import launch_d256_tn_direct as launch_bulk
    ...
    from .tn_tail_split import launch_tail_split

    if params.block_size == 16 and params.h_hk_ratio == 4 and (max_seqlen_k <= 2048):
        from .tn_boundary_merge import launch_boundary_merge
