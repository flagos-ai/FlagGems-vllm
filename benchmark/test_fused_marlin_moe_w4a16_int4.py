...
@pytest.mark.skipif(
    not (CUDA_AVAILABLE or ASCEND_AVAILABLE or SUPPORTED_DEVICE),
    reason="requires NVIDIA Hopper, a Hygon device or Ascend",
)
def test_fused_marlin_moe_w4a16_int4():
    """
    Benchmark the active backend using its same-precision W4A16 (vLLM) Marlin
