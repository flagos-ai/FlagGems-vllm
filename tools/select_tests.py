...
EXPLICIT_SOURCE_TO_TESTS = {
    "src/flaggems_vllm/ops/fused_marlin_moe_w4a16_mxfp4.py": [
        "tests/test_fused_marlin_moe_w4a16_mxfp4_ppu.py"
    ],
...
EXPLICIT_SOURCE_TO_BENCHMARKS = {
    "src/flaggems_vllm/ops/fused_marlin_moe_w4a16_mxfp4.py": [
        "benchmark/test_fused_marlin_moe_w4a16_mxfp4_ppu.py",
        "benchmark/test_fused_marlin_moe_w4a16_mxfp4_ppu_trace.py",
    ],
    "src/flaggems_vllm/runtime/backend/_thead/fused/fused_marlin_moe_w4a16_mxfp4.py": [
        "benchmark/test_fused_marlin_moe_w4a16_mxfp4_ppu.py",
        "benchmark/test_fused_marlin_moe_w4a16_mxfp4_ppu_trace.py",
